...
//                                        CW_USEDEFAULT, iWidth, iHeight, NULL, NULL, GetModuleHandle(NULL), NULL);
//             if (sMainWindow == NULL) {
//                 return false;
//             }
...
//             }
// #elif defined(_WIN32)
//             sMainWindow = CreateWindow(SZ_DEFAULT_APP_TITLE, SZ_DEFAULT_APP_TITLE, WS_POPUP, 0, 0, iWidth, iHeight, NULL,
...
//             sError += SDL_GetError();
//             SDL_ShowSimpleMessageBox(SDL_MESSAGEBOX_ERROR, "Error", sError.c_str(), NULL);
...
void RZGetCurrentAppPath(cIGZString& output) {
    char szPath[512];
#ifdef __linux__
    if (readlink("/proc/self/exe", szPath, sizeof(szPath)) == -1) {

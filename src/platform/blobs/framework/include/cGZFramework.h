...
private:
	...
	typedef std::tr1::unordered_map<GZGUID,
    cRZAutoRefCount<cIGZSystemService> > tServicesIdMap;
...
public:
	...
	virtual void* GetWindowsInstance();
	virtual void* GetMainHWND();
	virtual void SetMainHWND(void* hwnd);
#endif
